...
<form class="row g-3 needs-validation" novalidate >
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" name="telefono" id="numero_telefono" value="" required>
    <div class="invalid-feedback">
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="estatus" name="estatus" value="" required>
    <div class="invalid-feedback">
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" name="adeudo" id="adeudo" value="" required>
    <div class="invalid-feedback">
